...
wp core install --path=/var/www/html/wordpress --allow-root --url=$DOMAIN_NAME --title="$SITE_TITLE" --admin_user=$A_USER --admin_password=$A_PWD --admin_email=$A_EMAIL
...
wp config set ALLOW_UNFILTERED_HTML_COMMENT true
